if getgenv then -- if its a exploit then
  getfenv().script = Instance.new("LocalScript",game.Chat)
...
--[[ SERVICES ]]
    ...
    function createChatBubbleMain(filePrefix, sliceRect)
        ...
        chatBubbleMain.ImageColor3 = Color3.fromRGB(36, 36, 36)
    ...
    function createChatBubbleTail(position, size)
        ...
        chatBubbleTail.ImageColor3 = Color3.fromRGB(36, 36, 36)
	...
	result.ImageColor3 = Color3.fromRGB(36, 36, 36)
        ...
        image.Parent = result
        image.ImageColor3 = Color3.fromRGB(36, 36, 36)
    ...
    function this:BubbleChatEnabled()
        ...
        --	end
        --end
        return true -- PlayersService.BubbleChat
    end
